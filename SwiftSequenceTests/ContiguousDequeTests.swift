...
class ContiguousDequeTests: XCTestCase {
  ...
  func testDebugDescription() {
    ...
    let reality = ContiguousDeque(1...6).debugDescription
  ...
  func testCheck() {
    ...
    var reality = ContiguousDeque(1...6)
  ...
  func testArrayInit() {
    ...
    let reality = ContiguousDeque([1, 2, 3])
  ...
  func testSequenceType() {
    ...
    let reality = Array(ContiguousDeque([1, 2, 3]))
  ...
  func testIndexingRetrieval() {
    ...
    let deque = ContiguousDeque(10...15)
  ...
  func testIndexingSetting() {
    ...
    var reality = ContiguousDeque(0...5)
  ...
  func testFirst() {
    ...
    let reality = ContiguousDeque([1, 2, 3]).first
  ...
  func testLast() {
    ...
    let reality = ContiguousDeque([1, 2, 3]).last
  ...
  func testRangeIndexingRetrieval() {
    ...
    let deque = ContiguousDeque(0...10)
  ...
  func testAppend() {
    ...
    var reality = ContiguousDeque(0...10)
  ...
  func testPrepend() {
    ...
    var reality = ContiguousDeque(1...10)
  ...
  func testPrextend() {
    ...
    var reality = ContiguousDeque(6...10)
  ...
  func testRemoveAll() {
    ...
    var reality = ContiguousDeque(1...100)
  ...
  func testReverse() {
    ...
    let reality = ContiguousDeque(1...5).reverse()
  ...
  func testRemoveFirst() {
    ...
    var reality = ContiguousDeque(1...5)
  ...
  func testMap() {
    ...
    let reality = ContiguousDeque(1...3).map { $0 * 2 }
  ...
  func testFlatMap() {
    ...
    let before = ContiguousDeque(1...3)
    
    let reality = before.flatMap { ContiguousDeque([$0 * 2, $0 * 2 + 1]) }
  ...
  func testFlatMapOpt() {
    ...
    let before = ContiguousDeque(1...5)
  ...
  func testFilter() {
    ...
    let reality = ContiguousDeque(1...5).filter { $0 % 2 == 1 }
